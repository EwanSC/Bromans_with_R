...
ggsave("output_images/chronological_distribution/04.LIRE_corpus_plot.jpeg",
...
ggsave("output_images/chronological_distribution/05.LIRE_corpus_place_filter_plot.jpeg",
       width = 180, height = 100, unit = "mm", dpi = 600)
...
ggsave("output_images/chronological_distribution/06.LIRE_Dalmatia_plot.jpeg",
       width = 180, height = 100, unit = "mm", dpi = 600)
...
ggsave("output_images/chronological_distribution/07.LIRE_corpus_histogram_plot.jpeg",
       width = 180, height = 100, unit = "mm", dpi = 600)
...
ggsave("output_images/chronological_distribution/08.LIRE_corpus_place_filter_histogram_plot.jpeg",
       width = 180, height = 100, unit = "mm", dpi = 600)
...
ggsave("output_images/chronological_distribution/09.LIRE_Dalmatia_histogram_plot.jpeg",
       width = 180, height = 100, unit = "mm", dpi = 600)
...
ggsave("output_images/chronological_distribution/10.LIRE_Dalmatia_corpus_plot.jpeg",
       width = 180, height = 100, unit = "mm", dpi = 600)
...
ggsave("output_images/chronological_distribution/11.LIRE_Dalmatia_corpus_place_filter_plot.jpeg",
       width = 180, height = 100, unit = "mm", dpi = 600)
